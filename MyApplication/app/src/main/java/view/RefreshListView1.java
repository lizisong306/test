...
public class RefreshListView1 extends ListView {
    // 是否添加header，下拉刷新
    ...
    private SollectInterface sollectInterface;
    ...
    public RefreshListView1(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        if (addHeader) {
            ...
            lastUpdatedTextView.setVisibility(INVISIBLE);
        ...
        super.setOnScrollListener(new OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                RefreshListView1.this.scrollState = scrollState;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if(sollectInterface != null){
            sollectInterface.onTouchEvent(event);
        }
...
//                arrowImageView.setImageResource(R.mipmap.ic_pulltorefresh_arrow);
    ...
    private RefreshListView.PullInterceptListener mPullInterceptListener;

    public interface PullInterceptListener {
        public boolean isPullIntercept();
    }

    public void setPullInterceptListener(RefreshListView.PullInterceptListener ls) {
    ...
    private RefreshListView.OnPullUpToRefreshListener mOnPullUpToRefreshListener;
    private RefreshListView.OnPullDownToRefreshListener mOnPullDownToRefreshListener;

    public void setOnPullUpToRefreshListener(RefreshListView.OnPullUpToRefreshListener listener) {
        mOnPullUpToRefreshListener = listener;
    }

    public void setOnPullDownToRefreshListener(
            RefreshListView.OnPullDownToRefreshListener listener) {
    ...
    public void setInterface(SollectInterface list){
        this.sollectInterface = list;
    }
}

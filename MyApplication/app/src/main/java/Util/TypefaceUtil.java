...
public class TypefaceUtil {
    ...
    static Typeface surface = null;
    private static Typeface  getTypeface (AssetManager assets, String fontPath) {
        if (surface!=null) {
            return surface;
        } else {
            surface = Typeface.createFromAsset(assets, fontPath);
            return surface;
        }
    }
    ...
    public static void replaceFont(@NonNull View root, String fontPath) {
        ...
        if (root instanceof TextView) { // If view is TextView or it's subclass, replace it's font
            ...
            Typeface face = getTypeface(root.getContext().getAssets(), fontPath);
...
//    static Typeface surface = null;
//    public static Typeface replaceFont(@NonNull Activity context, String fontPath) {
//        if (surface!=null) {
//            return surface;
//        } else {
//            replaceFont(getRootView(context),fontPath);
//            surface = Typeface.createFromAsset(context.getAssets(), fontPath);
//            return surface;
//        }
//    }
    /*

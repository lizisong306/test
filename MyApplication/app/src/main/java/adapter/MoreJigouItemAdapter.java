...
/**
 * Created by lizisong on 2018/1/22.
 */

public class MoreJigouItemAdapter extends BaseAdapter {
    ...
    public MoreJigouItemAdapter() {
    }

    public MoreJigouItemAdapter(Context context, List<Posts> postsListData, String channelName) {
...
//            holder.librarys_linyu=(TextView)convertView.findViewById(R.id.librarys_linyu);
        ...
        try {
            ...
            if(postsListData.get(position).getTypename().equals("html") && postsListData.get(position).typeid.equals("2")){
                holder.librarys1.setVisibility(View.GONE);
...
//                holder.librarys_img1.setBackgroundResource(postsListData.get(position).litpic);
            ...
            else if (postsListData.get(position).getTypename().equals("实验室")|| postsListData.get(position).getTypename().equals("研究所")||channelName == "研究所") {
                holder.librarys1.setVisibility(View.GONE);
                holder.librarys.setVisibility(View.VISIBLE);
                holder.zx_layout.setVisibility(View.GONE);
                holder.zc_layout.setVisibility(View.GONE);
...
//                        }
                        ...
                        holder.xm_title.setText(postsListData.get(position).getTitle());
                        if(postsListData.get(position).getArea_cate().getArea_cate1()!=null){
                            holder.xm_linyu.setText(postsListData.get(position).getArea_cate().getArea_cate1());
                        }
                        if(postsListData.get(position).getDescription()==null || postsListData.get(position).getDescription().equals("")){
                            holder.xm_description.setVisibility(View.GONE);
...
//                }
            ...
            }else if (postsListData.get(position).getTypename().equals("资讯") || postsListData.get(position).getTypename().equals("推荐") || postsListData.get(position).getTypename().equals("活动") || postsListData.get(position).getTypename().equals("专题") || postsListData.get(position).getTypename().equals("知识")|| channelName == "资讯") {
                holder.librarys1.setVisibility(View.GONE);
                holder.line.setVisibility(View.VISIBLE);
                holder.zx_layout.setVisibility(View.VISIBLE);
                holder.librarys.setVisibility(View.GONE);
...
//                        }
                        ...
                        holder.librarys_title.setText(postsListData.get(position).getTypename());
                        read_ids = PrefUtils.getString(context, postsListData.get(position).getId(), "");
                        if(read_ids.equals("")){
                            holder.librarys_title.setTextColor(Color.parseColor("#181818"));
                        }else{
...
//           holder.librarys_linyu.setText(postsListData.get(position).getArea_cate().getArea_cate1());
            ...
            } else if (postsListData.get(position).getTypename().equals("项目") || channelName == "项目" || postsListData.get(position).typeid.equals("2")) {
                holder.librarys1.setVisibility(View.GONE);
                holder.xm_layout.setVisibility(View.VISIBLE);
                holder.librarys.setVisibility(View.GONE);
                holder.zx_layout.setVisibility(View.GONE);
...
//                }
            ...
            } else if (postsListData.get(position).getTypename().equals("人才") || postsListData.get(position).getTypename().equals("专家")||postsListData.get(position).typeid.equals("4")) {
                holder.librarys1.setVisibility(View.GONE);
                ...
                holder.rc_uname.setText(postsListData.get(position).getTitle());
                read_ids = PrefUtils.getString(context, postsListData.get(position).getId(), "");
                if(read_ids.equals("")){
...
//                        }
                        ...
                        holder.santu_name.setText(postsListData.get(position).getTypename());
                        holder.tj_state_zan.setText(postsListData.get(position).getZan());
                        holder.tj_state_click.setText(postsListData.get(position).getTitle());

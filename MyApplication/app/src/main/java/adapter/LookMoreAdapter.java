...
public class LookMoreAdapter extends BaseAdapter {
    ...
    public LookMoreAdapter(Context context, List<PostData> postsListData, String channelName) {
        this.context = context;
        this.postsListData = postsListData;
//        if(this.postsListData == null){
//            this.postsListData = new ArrayList<>();
//            for(int i=0; i<postsListData.size();i++){
//                PostData item =postsListData.get(i);
//                this.postsListData.add(item);
//            }
//        }else {
//            for(int i=0; i<postsListData.size();i++){
//                PostData item =postsListData.get(i);
...
//            holder.librarys_linyu=(TextView)convertView.findViewById(R.id.librarys_linyu);
        ...
        try {
            ...
            if(postsListData.get(position).typename.equals("html") && postsListData.get(position).typeid.equals("2")){
...
//                            holder.santu_zhiding.setVisibility(View.GONE);
//                        }
                        holder.tj_state_title.setText(postsListData.get(position).title);
                        read_ids = PrefUtils.getString(context, postsListData.get(position).id, "");
                        if(read_ids.equals("")){
                        ...
                        holder.santu_name.setText(postsListData.get(position).typename);

                        holder.tj_state_zan.setText(postsListData.get(position).zan);
                        holder.tj_state_click.setText(postsListData.get(position).click);
                        ...
                        if (postsListData.get(position).typename.equals("专题")) {
                        ...
                        holder.librarys_title.setText(postsListData.get(position).title);
                        read_ids = PrefUtils.getString(context, postsListData.get(position).id, "");
                        if(read_ids.equals("")){
...
//           holder.librarys_linyu.setText(postsListData.get(position).getArea_cate().getArea_cate1());
                        holder.datu_name.setText(postsListData.get(position).typename);
                        holder.librarys_zan.setText(postsListData.get(position).zan);
                        holder.librarys_look.setText(postsListData.get(position).click);
                ...
                holder.xm_title.setText(postsListData.get(position).title);
                if(postsListData.get(position).area_cate!=null){
                    holder.xm_linyu.setText(postsListData.get(position).area_cate);
                }
                if(postsListData.get(position).description==null || postsListData.get(position).description.equals("")){
                    holder.xm_description.setVisibility(View.GONE);
                }else{
                    holder.xm_description.setVisibility(View.GONE);
                    holder.xm_description.setText(postsListData.get(position).description);
                }
                ...
                holder.xm_name.setText(postsListData.get(position).typename);
...
//                holder.xm_dianwei.setText(postsListData.get(position).getZan());
                holder.xm_dianwei.setVisibility(View.GONE);
                holder.xm_look.setText(postsListData.get(position).click);
...
//                }
            ...
            }else if(postsListData.get(position).typename.equals("html")){
                holder.line.setVisibility(View.VISIBLE);
                ...
                holder.librarys_title1.setText(postsListData.get(position).title);
//                holder.librarys_img1.setBackgroundResource(postsListData.get(position).litpic);
                holder.shiyanshi_zhiding1.setVisibility(View.VISIBLE);


            }else if (postsListData.get(position).typename.equals("实验室")|| postsListData.get(position).typename.equals("研究所")||channelName == "研究所") {
                holder.librarys1.setVisibility(View.GONE);
                holder.librarys.setVisibility(View.VISIBLE);
                holder.zx_layout.setVisibility(View.GONE);
                holder.zc_layout.setVisibility(View.GONE);
...
//                        }
                        ...
                        holder.xm_name.setText(postsListData.get(position).typename);
                        holder.xm_dianwei.setVisibility(View.GONE);
                        holder.xm_dianwei.setText(postsListData.get(position).zan);
                        holder.xm_look.setText(postsListData.get(position).click);
                        holder.line.setVisibility(View.VISIBLE);
                    } else if (postsListData.get(position).imageState.equals("-1")) {
                        holder.librarys_img.setVisibility(View.GONE);
...
//                    holder.shiyanshi_zhiding.setVisibility(View.GONE);
//                }
            } else if(postsListData.get(position).typename.equals("活动") || channelName == "活动"){
                holder.librarys1.setVisibility(View.GONE);
...
//           holder.librarys_linyu.setText(postsListData.get(position).getArea_cate().getArea_cate1());
                ...
                holder.zx_title.setText(postsListData.get(position).title);
                read_ids = PrefUtils.getString(context, postsListData.get(position).id, "");
                if(read_ids.equals("")){
                ...
                holder.zx_lanyuan.setText(postsListData.get(position).typename);
                holder.zx_zan.setText(postsListData.get(position).zan);
                holder.zx_look.setText(postsListData.get(position).click);
...
//                }
            ...
            }else if (postsListData.get(position).typename.equals("资讯") || postsListData.get(position).typename.equals("推荐") || postsListData.get(position).typename.equals("活动") || postsListData.get(position).typename.equals("专题") || postsListData.get(position).typename.equals("知识")|| channelName == "资讯") {
                holder.librarys1.setVisibility(View.GONE);
                holder.line.setVisibility(View.VISIBLE);
                holder.zx_layout.setVisibility(View.VISIBLE);
                holder.librarys.setVisibility(View.GONE);
...
//                        }
                        ...
                        holder.librarys_title.setText(postsListData.get(position).typename);
                        read_ids = PrefUtils.getString(context, postsListData.get(position).id, "");
                        if(read_ids.equals("")){
                            holder.librarys_title.setTextColor(Color.parseColor("#181818"));
                        }else{
...
//           holder.librarys_linyu.setText(postsListData.get(position).getArea_cate().getArea_cate1());
            ...
            } else if (postsListData.get(position).typename.equals("项目") || channelName == "项目" || postsListData.get(position).typeid.equals("2")) {
                holder.librarys1.setVisibility(View.GONE);
                holder.xm_layout.setVisibility(View.VISIBLE);
                holder.librarys.setVisibility(View.GONE);
                holder.zx_layout.setVisibility(View.GONE);
...
//                    holder.xiangmu_zhiding.setVisibility(View.GONE);
//                }
            } else if (postsListData.get(position).typename.equals("政策")|| channelName == "政策") {
                holder.librarys1.setVisibility(View.GONE);
                ...
                holder.zc_title.setText(postsListData.get(position).title);
                read_ids = PrefUtils.getString(context, postsListData.get(position).id, "");
                if(read_ids.equals("")){
                ...
                holder.zc_description.setText(postsListData.get(position).description);
                holder.zc_look.setText(postsListData.get(position).click);
                holder.zc_zan.setText(postsListData.get(position).zan);
                holder.zc_lingyu.setText(postsListData.get(position).typename);
                holder.line.setVisibility(View.VISIBLE);
//                if (postsListData.get(position).getTags().equals("置顶")) {
...
//                }
            ...
            } else if (postsListData.get(position).typename.equals("人才") || postsListData.get(position).typename.equals("专家")||postsListData.get(position).typeid.equals("4")) {
                holder.librarys1.setVisibility(View.GONE);
                ...
                holder.rc_uname.setText(postsListData.get(position).username);
                read_ids = PrefUtils.getString(context, postsListData.get(position).id, "");
                if(read_ids.equals("")){
                ...
                holder.rc_title.setText(postsListData.get(position).description);
                holder.rc_zhicheng.setText(postsListData.get(position).rank);
                if(postsListData.get(position).is_academician!=null){
                    if(postsListData.get(position).is_academician.equals("1")){
                        holder.rc_yuanshi.setVisibility(View.GONE);
                    }else if(postsListData.get(position).is_academician.equals("0")){
                        holder.rc_yuanshi.setVisibility(View.GONE);
                    }
                }
                ...
                if(postsListData.get(position).source==null || postsListData.get(position).source.equals("")){
                    ...
                    holder.rc_zan.setText(postsListData.get(position).source);
                    if(this.state == 1){
                        Log.d("lizisong", "state:"+this.state);
                        holder.rc_zan.setVisibility(View.VISIBLE);
                    }else {
                ...
                holder.rank.setText(postsListData.get(position).rank);


                holder.rc_look.setText(postsListData.get(position).click);
                if (postsListData.get(position).litpic.equals("")) {
                    ...
                    if (state) {
                        NetUtils.NetType type = NetUtils.getNetType();
                        if (type == NetUtils.NetType.NET_WIFI) {
                            ImageLoader.getInstance().displayImage(postsListData.get(position).litpic
...
//                    holder.rencai_zhiding.setVisibility(View.GONE);
//                }
            } else if (postsListData.get(position).typename.equals("设备") || channelName == "设备") {
                holder.librarys1.setVisibility(View.GONE);
...
//                        }
                        ...
                        holder.santu_name.setText(postsListData.get(position).typename);
                        holder.tj_state_zan.setText(postsListData.get(position).zan);
                        holder.tj_state_click.setText(postsListData.get(position).title);
...
//           holder.librarys_linyu.setText(postsListData.get(position).getArea_cate().getArea_cate1());
                ...
                holder.device_title.setText(postsListData.get(position).title);
                if(postsListData.get(position).area_cate!=null){
                    holder.device_linyu.setText(postsListData.get(position).area_cate);
                }
                if(postsListData.get(position).description==null || postsListData.get(position).description.equals("")){
                    holder.device_description.setVisibility(View.GONE);
                }else{
                    holder.device_description.setVisibility(View.VISIBLE);
                    holder.device_description.setText(postsListData.get(position).description);
                }
                ...
                holder.device_zan.setText(postsListData.get(position).zan);
                holder.device_look.setText(postsListData.get(position).click);
                holder.line.setVisibility(View.VISIBLE);
//                if (postsListData.get(position).getTags().equals("置顶")) {
...
//                }
            ...
            } else if (postsListData.get(position).typename.equals("专利") || channelName == "专利") {
                holder.librarys1.setVisibility(View.GONE);
                ...
                holder.zhunli_title.setText(postsListData.get(position).title);
                if(postsListData.get(position).area_cate!=null ){
                    if(postsListData.get(position).area_cate==null || postsListData.get(position).area_cate.equals("")){
                        holder.zhuanli_line.setVisibility(View.GONE);
                    }else{
                        holder.zhuanli_line.setVisibility(View.VISIBLE);
                        holder.zhuanli_linyu.setText(postsListData.get(position).area_cate);
                    }
                }
                if(postsListData.get(position).description==null || postsListData.get(position).description.equals("")){
                    ...
                    holder.zhuanli_description.setVisibility(View.GONE);
                    holder.zhuanli_description.setText(postsListData.get(position).description);
                }
                read_ids = PrefUtils.getString(context, postsListData.get(position).id, "");
                if(read_ids.equals("")){
                ...
                holder.zhuanli_look.setText(postsListData.get(position).click);
                holder.zhuanli_zan.setText(postsListData.get(position).zan);
                holder.line.setVisibility(View.VISIBLE);
...
//                      holder.librarys_linyu.setText(postsListData.get(position).getArea_cate().getArea_cate1());
                ...
                holder.zx_zan.setText(postsListData.get(position).zan);
                holder.zx_look.setText(postsListData.get(position).click);
                if(postsListData.get(position).typename.equals("科讯早参")){
                    postsListData.get(position).typename="科讯早参";
                }else{
                    postsListData.get(position).typename="资讯";
                }

...
public class NewZhuanliActivity extends AutoLayoutActivity {
...
//            window.setNavigationBarColor(Color.BLACK);
        ...
        setContentView(R.layout.newzhuanliactivity);
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
        ...
        heart =  View.inflate(NewZhuanliActivity.this, R.layout.newzhuanliheart, null);
...
//                            title.getBackground().setAlpha(290-25-h);
        ...
        if (netWorkType == NetUtils.NETWORKTYPE_INVALID) {
            Toast.makeText(NewZhuanliActivity.this, "网络不给力", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void getJson(String aid, boolean state){
        String url= "http://"+ MyApplication.ip+"/api/arc_detail_patent.php";
    ...
    class Adapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            HoldView holdView;
            if(convertView == null){
                convertView = View.inflate(NewZhuanliActivity.this, R.layout.newzhuanliadapter, null);
...
//                holdView.laycontent.setText(item.str);
                ...
                holdView.zhuanli_layout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(NewZhuanliActivity.this, NewZhuanliActivity.class);
    ...
    class TextClick extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            if(mKeyWord.aid == null || (mKeyWord.aid != null && mKeyWord.aid.equals(""))){
                Intent intent = new Intent(NewZhuanliActivity.this, NewSearchContent.class);
                ...
                if(mKeyWord.typeid.equals("8")){
                    Intent intent=new Intent(NewZhuanliActivity.this, UnitedStatesDeilActivity.class);
                    intent.putExtra("aid",mKeyWord.aid);
                    intent.putExtra("typeid", mKeyWord.typeid);
                    startActivity(intent);

                }else if(mKeyWord.typeid.equals("4")){
                    Intent intent = new Intent(NewZhuanliActivity.this, XinFanAnCeShi.class);
                    intent.putExtra("aid", mKeyWord.aid);
                    intent.putExtra("typeid", mKeyWord.typeid);
                    startActivity(intent);

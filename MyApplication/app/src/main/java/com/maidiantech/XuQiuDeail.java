...
public class XuQiuDeail extends SlidingActivity {
    ...
    private String aid, json, bodys = "", linyu, title, str, zlstr, rcstr, sbstr, xmstr, replace, newhtml, area1s, xmpic, name, xmbody, area_cate1,
            area_cate2, area_cate3, cate2, cate3, titles, picimg, pic, area1, rank, rcrank, post_title, rcpost_title, opus,reward, rcreward, sbtitle, spec,
    ...
    Handler handlers = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 3) {
                Toast.makeText(XuQiuDeail.this, "请您登录", Toast.LENGTH_SHORT).show();
            }
        }
    };
    Handler
...
//                        update = cate3.replace("{time}", strTime);
                        ...
                        webview.loadDataWithBaseURL(baseUrl, XuQiuDeail.this.zx_souse, "text/html",
                                "utf-8", null);
                    }
...
//                    }
                        ...
                        String baseUrl = "file:///android_asset/";
                        webview.loadDataWithBaseURL(baseUrl, XuQiuDeail.this.zc_souse, "text/html",
                                "utf-8", null);
                        ...
                        String baseUrl = "file:///android_asset/";
                        webview.loadDataWithBaseURL(baseUrl, XuQiuDeail.this.linyu, "text/html",
                                "utf-8", null);
...
//                        xm_souse=xmbody.replace("{souse}",source);
                        ...
                        webview.loadDataWithBaseURL(baseUrl1, XuQiuDeail.this.xmpic, "text/html",
                                "utf-8", null);
                    } else {
                        if (data.getTypeid().equals("4")) {
                            ...
                            webview.loadDataWithBaseURL(baseUrl2, XuQiuDeail.this.search_project, "text/html",
                                    "utf-8", null);
                            ...
                            String baseUrl = "file:///android_asset/";
                            webview.loadDataWithBaseURL(baseUrl, XuQiuDeail.this.performance, "text/html",
                                    "utf-8", null);
...
//                        sb_souse = titles.replace("{souse}", source);
                            ...
                            String baseUrl = "file:///android_asset/";
                            webview.loadDataWithBaseURL(baseUrl, XuQiuDeail.this.xmbody, "text/html",
                                    "utf-8", null);
                        } else {
                            replace = str.replace("{{title}}", title);
                            newhtml = replace.replace("{{body}}", bodys);
            ...
            if (msg.what == 2) {
                ...
                if (zanCode.code == 1) {
                    ...
                    Toast.makeText(XuQiuDeail.this, zanCode.message, Toast.LENGTH_SHORT).show();
...
//            pic = intent.getStringExtra("pic");
            ...
            if (netWorkType == NetUtils.NETWORKTYPE_INVALID) {
                Toast.makeText(XuQiuDeail.this, "网络不给力", Toast.LENGTH_SHORT).show();
...
//                Log.d("lizisong", "webcontent:"+webcontent+",webnow:"+webnow);
                if (webcontent - webnow < 5) {
                    //已经处于底端
                    yuyue.setBackgroundResource(R.mipmap.quren_yy);
                } else {
                    if (webnow == webview.getHeight()) {
//                        Log.d("lizisong", "已经在顶端");
                    } else {
                        yuyue.setBackgroundResource(R.mipmap.queren);
                    }
                }
...
//            ScrollView2.setVisibility(View.VISIBLE);
            ...
            yuyue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AddRencai.isExit =true;
                    AddXuQiu.data = AddRencai.retdata;
                    finish();
...
//            ScrollView2.setVisibility(View.VISIBLE);
            ...
            yuyue.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AddProject.isExit=true;
                    AddXuQiu.data = AddProject.retdata;
                    finish();
                }
            });
        }
        ...
        if(name.equals("设备")){
            ...
            yuyue.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AddSheBei.isExit=true;
                    AddXuQiu.data = AddSheBei.retdata;
                    finish();
                }
            });
        }
        ...
        my_tishi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCollectionEntityzan != null) {
                    Toast.makeText(XuQiuDeail.this, "已经点过赞", Toast.LENGTH_SHORT).show();
            ...
            shares.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Intent intent = new Intent(XuQiuDeail.this, ShareActivity.class);
...
//                        UIHelper.showDialogForLoading(XuQiuDeail.this, "", true);
//                        if (pic == null || pic.equals("")) {
...
//                            image = new UMImage(XuQiuDeail.this, "http://www.maidiantech.com/uploads/logo/logo1.png");
//
//                        } else {
//                            image = new UMImage(XuQiuDeail.this, pic);
//                        }
//
...
//                                };
//                        action = new ShareAction(XuQiuDeail.this);
...
//                                    .withTitle(title)
//                                    .withTargetUrl("http://www.maidiantech.com/api/share.php?aid=" + aid + "")
//                                    .withMedia(image)
    ...
    public void dismisjson() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                sort.add("version"+MyApplication.version);
                sign = KeySort.keyScort(sort);
                quxiaojson = Okhttp.Myokhttpclient("http://" + ips + "/api/arc_store.php?id=" + id + "&mid=" + mids + "&method=cancel" + "&sign=" + sign + "&timestamp=" + timestamp+"&version="+MyApplication.version);
                Message msg = new Message();
                msg.what = 4;
                handler.sendMessage(msg);
            }
    ...
    public void collectjson() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                sort.add("version"+MyApplication.version);
                sign = KeySort.keyScort(sort);
                collectjson = Okhttp.Myokhttpclient("http://" + ips + "/api/arc_store.php?aid=" + aid + "&mid=" + mids + "&method=add" + "&sign=" + sign + "&timestamp=" + timestamp+"&version="+MyApplication.version);
                Message msg = new Message();
                msg.what = 3;
                handler.sendMessage(msg);
            }
...
//                        Toast.makeText(DetailsActivity.this, "请您登录", Toast.LENGTH_SHORT).show();
                        ...
                        sort.add("version"+MyApplication.version);
                        sign = KeySort.keyScort(sort);
                        zanjson = Okhttp.Myokhttpclient("http://" + ips + "/api/arc_zan.php?aid=" + aid + "&mid=" + mids + "&sign=" + sign + "&timestamp=" + timestamp+"&version="+MyApplication.version);
                        if (zanjson != null) {
                            Message msg = new Message();
                            msg.what = 2;
                            handler.sendMessage(msg);
    ...
    private UMShareListener umShareListener = new UMShareListener() {
        ...
        public void onError(SHARE_MEDIA platform, Throwable t) {
            Toast.makeText(XuQiuDeail.this, platform + "分享失败", Toast.LENGTH_SHORT).show();
            if (t != null) {
            }
        }

...
/**
 * Created by lizisong on 2017/7/27.
 */

public class RencaiActivity extends SlidingActivity {
    ...
    Button yuyue;
    String zchtml, opus,search_project, research_project, username, rc_name, source, rc_souse, zx_souse, zc_souse, xm_souse, sb_souse, sysstr, ment, type, zanjson;
    ...
    String name1,linyu1,danwei1,yuyuecount1,imgURL1 ;
    ...
    Handler handlers = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 3) {
                Toast.makeText(RencaiActivity.this, "请您登录", Toast.LENGTH_SHORT).show();
            }
        }
    };
    Handler
...
//                        update = cate3.replace("{time}", strTime);
                        ...
                        webview.loadDataWithBaseURL(baseUrl, RencaiActivity.this.zx_souse, "text/html",
                                "utf-8", null);
                    }
...
//                    }
                        ...
                        String baseUrl = "file:///android_asset/";
                        webview.loadDataWithBaseURL(baseUrl, RencaiActivity.this.zc_souse, "text/html",
                                "utf-8", null);
                        ...
                        String baseUrl = "file:///android_asset/";
                        webview.loadDataWithBaseURL(baseUrl, RencaiActivity.this.linyu, "text/html",
                                "utf-8", null);
...
//                        xm_souse=xmbody.replace("{souse}",source);
                        ...
                        webview.loadDataWithBaseURL(baseUrl1, RencaiActivity.this.xmpic, "text/html",
                                "utf-8", null);
                    } else {
                        if (data.getTypeid().equals("4")) {
                            ...
                            webview.loadDataWithBaseURL(baseUrl2, RencaiActivity.this.search_project, "text/html",
                                    "utf-8", null);
                            ...
                            String baseUrl = "file:///android_asset/";
                            webview.loadDataWithBaseURL(baseUrl, RencaiActivity.this.performance, "text/html",
                                    "utf-8", null);
...
//                        sb_souse = titles.replace("{souse}", source);
                            ...
                            String baseUrl = "file:///android_asset/";
                            webview.loadDataWithBaseURL(baseUrl, RencaiActivity.this.xmbody, "text/html",
                                    "utf-8", null);
                        } else {
                            replace = str.replace("{{title}}", title);
                            newhtml = replace.replace("{{body}}", bodys);
            ...
            if (msg.what == 2) {
                ...
                if (zanCode.code == 1) {
                    ...
                    Toast.makeText(RencaiActivity.this, zanCode.message, Toast.LENGTH_SHORT).show();
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linyu1 = getIntent().getStringExtra("linyu1");
        danwei1 = getIntent().getStringExtra("danwei1");
        yuyuecount1 = getIntent().getStringExtra("count1");
        imgURL1 = getIntent().getStringExtra("img1");
...
//            pic = intent.getStringExtra("pic");
            ...
            if (netWorkType == NetUtils.NETWORKTYPE_INVALID) {
                Toast.makeText(RencaiActivity.this, "网络不给力", Toast.LENGTH_SHORT).show();
            ...
            yuyue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!loginState.equals("1")) {
                        Intent intent = new Intent(RencaiActivity.this, MyloginActivity.class);
                        ...
                        Intent intent = new Intent(RencaiActivity.this, UnitActivity.class);
                        startActivity(intent);
                    } else {

                        Intent intent = new Intent(RencaiActivity.this, YuyueRenCai.class);
                        intent.putExtra("original_price", original_price);
                        intent.putExtra("current_price", current_price);

                        intent.putExtra("aid", aid);
                        intent.putExtra("name", name1);
                        intent.putExtra("linyu", linyu1);
                        intent.putExtra("danwei",danwei1);
                        intent.putExtra("img",imgURL1);
                        intent.putExtra("count",yuyuecount1);
                        intent.putExtra("zhicheng", zhicheng);
                        startActivity(intent);

//                        Intent intent = new Intent(RencaiActivity.this, AddXuQiu.class);
        ...
        my_tishi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCollectionEntityzan != null) {
                    Toast.makeText(RencaiActivity.this, "已经点过赞", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            shares.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(RencaiActivity.this, ShareActivity.class);
                    ...
                    if (pic == null || pic.equals("")) {
                         intent.putExtra("imageurl", "http://www.zhongkechuangxiang.com/uploads/logo/logo1.png");
                    }else{
                        intent.putExtra("imageurl", pic);
                    }
                    startActivity(intent);
//                    try {
//                        UIHelper.showDialogForLoading(RencaiActivity.this, "", true);
//                        if (pic == null || pic.equals("")) {
...
//                            image = new UMImage(RencaiActivity.this, "http://www.zhongkechuangxiang.com/uploads/logo/logo1.png");
//
//                        } else {
//                            image = new UMImage(RencaiActivity.this, pic);
//                        }
//
...
//                                };
//                        action = new ShareAction(RencaiActivity.this);
...
//                        Toast.makeText(DetailsActivity.this, "请您登录", Toast.LENGTH_SHORT).show();
    ...
    private UMShareListener umShareListener = new UMShareListener() {
        ...
        public void onError(SHARE_MEDIA platform, Throwable t) {
            Toast.makeText(RencaiActivity.this, platform + "分享失败", Toast.LENGTH_SHORT).show();
            if (t != null) {
            }
        }
...
//                    http://www.maidiantech.com/api/arc_detail.php?aid="+aid+"&mid="+mids+"&deviceid="+deviceid+"&typeid="+"1"+"
                    ...
                    } else if (name.equals("实验室") || name.equals("研究所") || name.equals("研究院")) {
                        sort.add("typeid" + "8");
                        sort.add("version"+MyApplication.version);
                        sign = KeySort.keyScort(sort);

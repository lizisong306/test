...
public class DFBaoTouMore extends AutoLayoutActivity {
    ImageView back;
        ...
        list.setOnPullDownToRefreshListener(new RefreshListView.OnPullDownToRefreshListener() {
            ...
            public void pullDownToRefresh() {
                ...
                if (netWorkType == NetUtils.NETWORKTYPE_INVALID) {
                    Toast.makeText(DFBaoTouMore.this, "网络不给力", Toast.LENGTH_SHORT).show();
                } else {
//                    postsListData.clear();
//                    hashMap.clear();
                    if(Recomment!=null){
...
//                            psc.onRefreshComplete();
                        ...
                        if (postsListData.get(postsListData.size() - 1).getResult() != null && postsListData.get(postsListData.size() - 1).getResult().equals("no")) {
                            ...
                            Toast.makeText(DFBaoTouMore.this, "已是最后一条数据",Toast.LENGTH_SHORT).show();
...
//                    }
                    ...
                    if(Recomment==null){
                        Recomment=new RecommendAdapter(DFBaoTouMore.this, postsListData, channelName, mytitle);
                        if(city.equals("包头")){
...
//                    lunboadapter.notifyDataSetChanged();
                    ...
                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            try {
                                PrefUtils.setString(DFBaoTouMore.this,postsListData.get(position - 1).getId(),postsListData.get(position - 1).getId());
                                if(postsListData.get(position-1).getTypename().equals("专题")){
                                    Intent intent = new Intent(DFBaoTouMore.this, SpecialActivity.class);
                                    ...
                                    if(name != null && (name.equals("资讯")||name.equals("推荐轮播图")|| name.equals("推荐") || name.equals("活动")|| name.equals("知识"))){
                                        if(city.equals("北京")){
                                            Intent intent = new Intent(DFBaoTouMore.this, BejingCeShi.class);
                                            intent.putExtra("id", postsListData.get(position - 1).getId());
                                            ...
                                            Intent intent=new Intent(DFBaoTouMore.this, WebViewActivity.class);
                                            intent.putExtra("title", postsListData.get(position - 1).getTitle());
                                            intent.putExtra("url", postsListData.get(position - 1).detail);
                                            startActivity(intent);

                                        }else{
                                            Intent intent = new Intent(DFBaoTouMore.this, ZixunDetailsActivity.class);
                                            intent.putExtra("id", postsListData.get(position - 1).getId());
                                            intent.putExtra("name", postsListData.get(position - 1).getTypename());
                                            intent.putExtra("pic", postsListData.get(position - 1).getLitpic());
                                            startActivity(intent);
                                        ...
                                        if(city.equals("全国")){
                                            ...
                                            Intent intent=new Intent(DFBaoTouMore.this, ActiveActivity.class);
                                            intent.putExtra("title", postsListData.get(position - 1).getTitle());
                                            intent.putExtra("url", postsListData.get(position - 1).detail);
                                            startActivity(intent);
                                        }else if(postsListData.get(position - 1).getTypename().equals("html")|| postsListData.get(position-1).typeid.equals("10000")){
                                            ...
                                            if(postsListData.get(position - 1).typeid.equals("4")){
                                                Intent intent = new Intent(DFBaoTouMore.this, XinFanAnCeShi.class);
                                                intent.putExtra("aid", postsListData.get(position - 1).getId());
                                                startActivity(intent);
                                            }else if(postsListData.get(position - 1).typeid.equals("2")){
                                                Intent intent = new Intent(DFBaoTouMore.this, NewProjectActivity.class);
                                                intent.putExtra("aid", postsListData.get(position - 1).getId());
                                                startActivity(intent);
                                            }
                                            else{
                                                Intent intent = new Intent(DFBaoTouMore.this, DetailsActivity.class);
                                                intent.putExtra("id", postsListData.get(position - 1).getId());
                                                intent.putExtra("name", postsListData.get(position - 1).getTypename());
                                                intent.putExtra("pic", postsListData.get(position - 1).getLitpic());
                                                startActivity(intent);

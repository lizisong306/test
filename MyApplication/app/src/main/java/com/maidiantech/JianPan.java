...
public class JianPan  extends AutoLayoutActivity {
    ...
    //头部数据展示
    View heartView;
    TextView rencai_titie,rencai_title,rencai_rank,rencai_linyu,shijijiage,yuanjia,yuyuebutton,adress_time,adress_content,des,jieshou_button,jieshou_cenel,gopay,pay_shengyu_time;
    LinearLayout rencai_content,heartbg,pay_lay,jiagelay;
    RelativeLayout rencai_img,adress_lay,jieshou0rcencel;
    ImageView xm_img;
...
//        }
        setContentView(R.layout.testbuju);
...
//                    commitContent();
//                }else {
//                    Toast.makeText(JianPan.this, "发送内容不能为空", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//        progress = (ProgressBar)findViewById(R.id.progress);
//        heartView = View.inflate(JianPan.this, R.layout.communicationandreplyheart, null);
...
//                    heartbg.setBackgroundResource(R.drawable.shape_top_xiangmu);
...
//                    heartbg.setBackgroundResource(R.drawable.shape_top_rencai);
//                    if(item.litpic != null && !item.litpic.equals("")){
...
//
//                    heartbg.setBackgroundResource(R.drawable.shape_top_shebei);
//                    if(item.litpic != null && !item.litpic.equals("")){
//                        rc_img.setVisibility(View.GONE);
//                        xm_img.setVisibility(View.VISIBLE);
//                        ImageLoader.getInstance().displayImage(item.litpic
...
//                    heartbg.setBackgroundResource(R.drawable.shape_top_zhuanli);
...
//                        pay_shengyu_time.setText("支付剩余时间："+current);
    ...
    class PingLunAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                ...
                convertView = View.inflate(JianPan.this, R.layout.pinglunadapter, null);
            ...
            if(msg.what == 2){
                try {
                    ...
                    if(ret1.code.equals("1")){
                        Toast.makeText(JianPan.this, ret1.message, Toast.LENGTH_SHORT).show();
                        time="";
                        arrayList.clear();
                        getData();
                    }
            ...
            if(msg.what == 3){
                try {
                    ...
                    if(ret != null){
                        ...
                        Toast.makeText(JianPan.this, ret.message.replaceAll("<br>","\n"), Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){

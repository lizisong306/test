...
import adapter.AddRenCaiAdapter;
...
public class AddRencai extends com.maidiantech.common.ui.BaseActivity {
    LinearLayout layout;
    RefreshListView list;
    TextView cenel,queren;
    RelativeLayout bottmon;
    AddRenCaiAdapter adapter;
    private  String   ips;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addrencai);
        setSystemBar();
        setRightIconHide();
        setTitle("选择专家");
        isExit = false;
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddRencai.this, XuQiuSearch.class);
                intent.putExtra("type","rencai");
        ...
        queren.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AddRencai.this, TianXuQiu.class);
        ...
        list.setOnPullDownToRefreshListener(new RefreshListView.OnPullDownToRefreshListener() {
            ...
            public void pullDownToRefresh() {
                ...
                if (netWorkType == NetUtils.NETWORKTYPE_INVALID) {
                    Toast.makeText(AddRencai.this, "网络不给力", Toast.LENGTH_SHORT).show();
                ...
                if (netWorkType == NetUtils.NETWORKTYPE_INVALID) {
                    ...
                    if(postsListData.size()==0){
                        ...
                        if (postsListData.get(postsListData.size() - 1).getResult() != null && postsListData.get(postsListData.size() - 1).getResult().equals("no")) {
                            Toast.makeText(AddRencai.this, "没有更多数据", Toast.LENGTH_SHORT).show();
                            list.setPullUpToRefreshFinish();
                        }
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("需求-添加人才");
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("需求-添加人才");
        ...
        try {
            if(adapter != null){
                ...
                if(postsListData != null){
                    if(XuQiuSearch.rencai != null){
                        if(XuQiuSearch.rencai.size() >0){
                            adapter.setCurrent(-1);
                            bottmon.setVisibility(View.GONE);
                            adapter.setCurrent(-1);
                            ...
                            postsListData.clear();
                            for(int i=0; i<XuQiuSearch.rencai.size();i++){
                                Renlist temp = XuQiuSearch.rencai.get(i);
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                if (msg.what == 3){
                    ...
                    if (adapter == null) {
                        adapter = new AddRenCaiAdapter(AddRencai.this, postsListData);

 ...
 */
public class SlidingLayout extends FrameLayout  implements SlidingScolling{
    ...
    public void setSlidingLayout(MotionEvent event){
        onTouchEvent(event);
    }
    int startX =0;
    ...
    @Override
    public boolean Scolling(View v, MotionEvent event) {
        onTouchEvent(event);
        return false;
    }
}

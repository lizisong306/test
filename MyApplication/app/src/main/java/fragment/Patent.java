...
public class Patent extends BaseFragment {
    private View view;
...
//                Log.d("lizisong", "getjsons gogogo");
                ...
                try {
                    if (channelName == "专利") {
                        ...
                        jsons = Okhttp.Myokhttpclient("http://"+ips+"/api/arc_index.php?pageSize=" + Size /*+ "&LastModifiedTime=" + pubdate*/ + "&typeid=5"+"&evalue="+evalue);
                    }
...
//                    UIHelper.hideDialogForLoading();
     ...
     * handler更新UI
     */
    private Patent.MyHandler handler = new Patent.MyHandler(this);
...
//            UIHelper.hideDialogForLoading();
    ...
    private class MyHandler extends Handler {
        WeakReference<Patent> weakReference;

        public MyHandler(Patent fragment) {
            weakReference = new WeakReference<Patent>(fragment);
        }

            ...
            public void run() {
                ...
                try {
                    if (channelName == "设备") {
                        ...
                        jsons = Okhttp.Myokhttpclient("http://"+ips+"/api/arc_index.php?pageSize=" + Size /*+ "&LastModifiedTime=" + pubdate */+ "&typeid=7"+"&evalue="+evalue);
                    }
...
//                    UIHelper.hideDialogForLoading();
     ...
     * handler更新UI
     */
    private Equipment.MyHandler handler = new Equipment.MyHandler(this);
...
//            UIHelper.hideDialogForLoading();
    ...
    private class MyHandler extends Handler {
        WeakReference<Equipment> weakReference;

        public MyHandler(Equipment fragment) {
            weakReference = new WeakReference<Equipment>(fragment);
        }

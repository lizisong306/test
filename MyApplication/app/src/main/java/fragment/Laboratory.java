...
public class Laboratory extends BaseFragment {
    private View view;
...
//                Log.d("lizisong", "getjsons gogogo");
                try {
                    if(channelName=="研究所"){
                        ...
                        jsons = Okhttp.Myokhttpclient("http://"+ips+"/api/arc_index.php?pageSize=" + Size /*+ "&LastModifiedTime=" + pubdate*/ + "&typeid=8"+"&evalue="+evalue);
                    }
                    mHasLoadedOnce = true;
                    //关闭对话框
                    // Log.i("jsons",jsons);
...
//                    UIHelper.hideDialogForLoading();
     ...
     * handler更新UI
     */
    private Laboratory.MyHandler handler = new Laboratory.MyHandler(this);
...
//            UIHelper.hideDialogForLoading();
    ...
    private class MyHandler extends Handler {
        WeakReference<Laboratory> weakReference;

        public MyHandler(Laboratory fragment) {
            weakReference = new WeakReference<Laboratory>(fragment);
        }

...
public class My_project extends BaseFragment {
    private View view;
...
//                Log.d("lizisong", "getjsons gogogo");
                try {
                    if (channelName == "项目") {
                        ...
                        jsons = Okhttp.Myokhttpclient("http://"+ips+"/api/arc_index.php?pageSize=" + Size/* + "&LastModifiedTime=" + pubdate */+ "&typeid=2"+"&evalue="+evalue);
                    }
                    mHasLoadedOnce = true;
     ...
     * handler更新UI
     */
    private My_project.MyHandler handler = new My_project.MyHandler(this);
...
//            UIHelper.hideDialogForLoading();
    ...
    private class MyHandler extends Handler {
        WeakReference<My_project> weakReference;

        public MyHandler(My_project fragment) {
            weakReference = new WeakReference<My_project>(fragment);
        }

...
public class My_Personnel extends BaseFragment {
            ...
            public void run() {
                ...
                try {
                    if (channelName == "专家") {
                        ...
                        jsons = Okhttp.Myokhttpclient("http://"+ips+"/api/arc_index.php?pageSize=" + Size /*+ "&LastModifiedTime=" + pubdate*/ + "&typeid=4"+"&evalue="+evalue);
...
//                    UIHelper.hideDialogForLoading();
     ...
     * handler更新UI
     */
    private My_Personnel.MyHandler handler = new My_Personnel.MyHandler(this);
...
//            UIHelper.hideDialogForLoading();
    ...
    private class MyHandler extends Handler {
        WeakReference<My_Personnel> weakReference;

        public MyHandler(My_Personnel fragment) {
            weakReference = new WeakReference<My_Personnel>(fragment);
        }

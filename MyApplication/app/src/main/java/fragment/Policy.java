...
public class Policy extends BaseFragment {
            ...
            public void run() {
                ...
                try {
                    if (channelName == "政策") {
                        ...
                        jsons = Okhttp.Myokhttpclient("http://"+ips+"/api/arc_index.php?pageSize=" + Size /*+ "&LastModifiedTime=" + pubdate */+ "&typeid=6"+"&evalue="+evalue);
                    }
...
//                    UIHelper.hideDialogForLoading();
     ...
     * handler更新UI
     */
    private Policy.MyHandler handler = new Policy.MyHandler(this);
    ...
    private class MyHandler extends Handler {
        WeakReference<Policy> weakReference;

        public MyHandler(Policy fragment) {
            weakReference = new WeakReference<Policy>(fragment);
        }
